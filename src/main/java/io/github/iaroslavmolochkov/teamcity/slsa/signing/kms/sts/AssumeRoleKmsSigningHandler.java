...
/** KMS signing with credentials from assuming an IAM role via STS, over the default chain. */
@Component
public class AssumeRoleKmsSigningHandler extends AbstractKmsSigningHandler {

    public AssumeRoleKmsSigningHandler(KmsClientCache cache, ConnectionIdService connectionIdService, DsseService dsse) {
